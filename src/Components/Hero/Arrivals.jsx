    ...
    <>
      ...
      <div className='mt-20 bg-white p-4 md:flex md:gap-20 md:items-center'>
        <div className='text-5xl md:w-1/2 md:p-10'>
          <h1 className='text-gray-500 text-wrap tracking-wide mt-2 font-bold uppercase'>
            Summer <br /> breeze 2024: 
            <span className='text-gray-700'> Where style meets sunshine</span>
          </h1>
          <p className='text-xl text-black font-semibold mt-6 leading-relaxed md:text-2xl'>
            Dive into the heart of summer with our "Summer Breeze 2024" collection, a refreshing take on seasonal fashion.
            This line is a tribute to the vibrant energy of the sunniest days, featuring chic and comfortable pieces that speak to the soul of summer.
          </p>
          <button className='text-xl uppercase w-64 h-20 mt-15 bg-blue-950 text-white tracking-wide p-2 rounded hover:bg-blue-800'>
            Explore Collection
          </button>
        </div>
      ...
      <div className='gap-4 items-center justify-center md:flex'>
        {explore.map((item) => (
          <div
            className='uppercase space-y-2 text-2xl flex flex-col py-8 items-center hover:bg-white hover:opacity-80 transition-all duration-200 ease-in-out md:w-5/12 lg:w-8/12 md:text-xl'
            onClick={nextpage}
          >
      ...
      <div className='mt-20 p-4 md:flex md:gap-20 md:items-center justify-center bg-white'>
        ...
        <div className='text-5xl md:w-[700px] md:p-1'>
          <h1 className='text-gray-500 text-xl tracking-wide mt-2 font-bold uppercase md:text-7xl'>
            Locate Your <br />
          ...
          <button className='text-xl font-bold uppercase w-45 h-15 mt-8 bg-gray-600 text-white tracking-wide p-2'>
            Find Now
          </button>
        </div>
      </div>
